...
/**
 * A highly customizable and accessible button component.
 * Supports variants (e.g., default, outline, destructive), sizes, and polymorphic behavior via `asChild`.
 */
...
const Button = React.forwardRef(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    // The component to render: either the Radix Slot or a standard <button> element.
